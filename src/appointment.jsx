                ...
                <tr key={index} style={{ borderBottom: '1px solid #1E88E5', color: '#1E88E5' }}>
                  ...
                  <td>
                    <button
                      ...
                      style={{ backgroundColor: '#1E88E5', color: '#fff', padding: '8px 16px', borderRadius: '5px', border: 'none', cursor: 'pointer', marginRight: '8px' }}
                    ...
                    <button
                      ...
                      style={{ backgroundColor: '#ff4444', color: '#fff', padding: '8px 16px', borderRadius: '5px', border: 'none', cursor: 'pointer' }}
